...
export default function MobileDrawer({
  ...
  return (
    <Drawer anchor="left" open={open} onClose={setOpen} variant="permanent">
      <section
        className={styles({
          "h-screen": true,
          ...
          {links.map((link, index) => (
            <Link href={link.path} key={index}>
              <p
                ...
                className={styles({
                  "flex justify-start  py-[2rem] capitalize w-full items-center transition-colors pl-[1rem]":
                    true,
                  ...
                  "bg-gray-100  text-black hover:text-zinc-600":
